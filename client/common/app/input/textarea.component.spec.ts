...
describe('Text Area Input Component', function() {
  var $compile;
  var $rootScope;

  beforeEach(angular.mock.module('common.input', 'common/app/input/textarea.html'));
  ...
  it('should compile', function() {
    ...
    var element = angular.element('<form name="testForm"><pwb-text-area-input ' +
                                'label="testLabel" ' +
                                'input-id="testId"' +
                                'input-name="testName" ' +
                                'model="testModel" ' +
                                'description="test description">' +
                              '</pwb-text-area-input></form>');

    $compile(element)(scope);
    scope.$digest();

    var dirScope = element.find('pwb-text-area-input').isolateScope() as any;
