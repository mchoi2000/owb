...
var LogentriesError = exports.LogentriesError = function (_Error) {
	...
	function LogentriesError(msg) {
		...
		var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(LogentriesError).call(this, msg));
...
var BadOptionsError = exports.BadOptionsError = function (_LogentriesError) {
	...
	function BadOptionsError(opts, msg) {
		...
		var _this2 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(BadOptionsError).call(this, msg));
