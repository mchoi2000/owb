...
{ packages:
   { jquery:
      { main: [Object],
        ...
        name: 'jquery',
        dependencies: {} } },
  js: [ 'client/public/bower_components/jquery/dist/jquery.js' ] }
```
...
<body>
  <!-- bower:js -->
  <script src="client/public/bower_components/jquery/dist/jquery.js"></script>
  <!-- endbower -->
</body>
</html>
```
...
```js
require('wiredep')({
  directory: 'the directory of your Bower packages.', // default: '.bowerrc'.directory || client/public/bower_components
  ...
  exclude: [ /jquery/, 'client/public/bower_components/modernizr/modernizr.js' ],
  ...
  onError: function(err) {
    ...
    //   - "BOWER_COMPONENTS_MISSING" (cannot find the `client/public/bower_components` directory)
  },
