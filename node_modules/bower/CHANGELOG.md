...
- Allow for client/public/bower_components to be a symlink
...
- Bower no longer fails if `symlinks` to files are present in the `client/public/bower_components` folder ([#783](https://github.com/bower/bower/issues/783) and [#791](https://github.com/bower/bower/issues/791))
...
- __Change bower default folder from `components` to `client/public/bower_components`__ ([#434](https://github.com/bower/bower/issues/434))
